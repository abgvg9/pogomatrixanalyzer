...
Run Instructions:
  For compilation:
  g++ team_analyzer_no_weaknesses.cpp -std=c++11 -o team_analyzer_no_weaknesses
  To run:
  ./team_analyzer_no_weaknesses <(input matrix).csv >(output file).csv
*/
          ...
          for(int n = m + 1; n < species.size(); n++)
          {
            ...
            for(int o = n + 1; o < species.size(); o++)
            {
              ...
              for(int l = 0; l < species.size(); l++)
              {
                ...
                if(matrix[m][l] > highest_score)
                {
                  highest_score = matrix[m][l];
                }
                if(matrix[n][l] > highest_score)
                {
                  highest_score = matrix[n][l];
                }
                if(matrix[o][l] > highest_score)
                {
                  highest_score = matrix[o][l];
                }
